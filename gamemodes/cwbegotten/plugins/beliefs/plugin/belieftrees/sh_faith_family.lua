	...
	FAMILY.beliefs = {
		[1] = {
			...
			["fearsome_wolf"] = {
				...
				subfaith = "Faith of the Father",
				description = "Upgrades the 'Warcry' ability: For 20 seconds, you deal 20% more regular and stamina damage, 15% more stability damage against all players and NPCs, sprint 10% faster, and reduce melee attack delay by 20%. Killing a player will reset your warcry cooldown. Also increases throwing axe damage by 15%.",
